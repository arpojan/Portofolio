...
export default function Projects() {
  ...
  const projects = [
    ...
    { img: "Design.jpg", tag: "Design", title: "GKN — Brand Identity", desc: "Perancangan identitas visual lengkap untuk GKN: logo, panduan brand, dan materi marketing. Konsisten di seluruh touchpoint — dari digital hingga media cetak.", tech: ["Canva", "Photoshop", "Illustrator"], link: "Design.pdf", github: "#" }
  ];
